...
def get_cheque_image(date):
    ...
    payee_name_text = payee_text(payee='**MULLER & PHIPPS PAKISTAN (PVT) LTD.**', width=config['payee_name_box_width'], height=config['payee_name_box_height'], color=config['payee_name_box_color'], font_size=config['payee_name_box_font'])
    ...
    amount_figur = amount_figur_text(amount='=100,000.00/-', width=config['amount_figur_box_width'], height=config['amount_figur_box_height'], color=config['amount_figur_box_color'], font_size=config['amount_figur_box_font'])
